...
import RenderState (RenderState (score, gameOver), BoardInfo, HasRenderState (getRenderState, setRenderState), HasBoardInfo (getBoardInfo), RenderMessage, updateMessages, buildBoard)
